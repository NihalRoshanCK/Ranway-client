  ...
  const handleUpdate = async (e) => {
    ...
    if (!isValidName(data.name)) {
      ...
      return toast.warning(
        "Enter a valid phone number format requires 10 digit"
      );
    }
    if (selectedImage) {
      ...
      if (!allowedFileTypes.includes(data.profile_picture.type)) {
        return toast.warning(
          "Invalid file type. Please select a .jpg, .jpeg, .png, or .gif file."
        );
      } else {
    ...
    if (data.password) {
      ...
      if (!isValidPassword(data.password)) {
        return toast.warning(
          "Password requires at least one uppercase letter, one lowercase letter, and one special character"
        );
      }
    ...
    api
      .patch(`auths/user/${userId}/`, formData)
      .then((response) => {
      ...
      >
        ...
        <DialogBody divider className="">
          ...
          <ol class="md:flex md:w-full md:mb-10 ">
            ...
            >
              <h3
                className={`hidden md:flex text-sm mx-4 my-3 font-semibold ${
                  order?.created_at
                    ? "text-green-300"
                    : order?.returned_at
                    ? "text-red-300"
              ...
              <div class="md:flex md:items-center mx-5 md:m-0 ">
                <div
                ...
                <div
                  class={`hidden md:flex w-full bg-gray-200 h-0.5 ${
                    order?.returned_at
                      ? "bg-red-300"
                      : order?.created_at
                      ? "bg-green-300"
                ...
                />
                <div
                  className="flex md:hidden w-0.5 h-28 mx-1.5 bg-gray-500"
                  class={`flex md:hidden w-0.5 h-28 mx-1.5 bg-gray-200 ${
                    order?.returned_at
                      ? "bg-red-300"
                      : order?.created_at
                      ? "bg-green-300"
              ...
              <h3
                className="md:hidden flex text-sm font-normal leading-none break-before-all text-gray-400 dark:text-gray-500"
              >
              ...
              <div class="hidden md:flex mx-5 my-3  ">
              ...
              <div className="mb-10 flex items-center justify-between gap-6">
                <div className="sm:flex sm:space-y-3 items-center gap-6">
                  ...
                  <div>
                    <Typography
                      variant="h5"
                      color={user.name ? "blue-gray" : "red"}
                      className="mb-1 break-all"
                    >
                      <span className="text-xl">Name :</span>{" "}
                      {user.name ? user?.name : "Edit the name"}
                    </Typography>
                    <Typography
                      variant=" "
                      color="blue-gray"
